...
(1, 'Basic Mathematics', 'The foundation of numerical understanding, covering essential concepts like counting, arithmetic, and basic geometry.'),
(2, 'Introduction to IT', 'A foundational course covering basic computer concepts, software, and hardware.');
...
CREATE TABLE `users` (
  ...
  `role` int(20) NOT NULL COMMENT '1-user 0-Student'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(7, 'Admin', '1234', 'admin@nbsc.edu.ph', '2024-11-07 18:54:11', 1);
